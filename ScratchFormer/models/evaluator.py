...
class CDEvaluator():
    ...
    if os.path.exists(ckpt_path):
        ...
        # ✅ FIX: weights_only=False to avoid UnpicklingError in PyTorch 2.6+
        checkpoint = torch.load(
            ckpt_path,
            map_location='cpu',
            weights_only=False  # <-- fix inserted here
        )
        ...
        # remove 'module.' keyword if present
        for key in keys:
